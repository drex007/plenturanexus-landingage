    ...
    return (
        <div className='overflow-hidden md:h-[100vh] lg:h-[120vh] 2xl:h-[90vh] w-full m-auto relative '>
            ...
            {currentIndex == 1 && <div className='absolute lg:top-[70%] top-[50%] h-full  justify-start  px-8 lg:w-1/2 w-full'>
                <p className='2xl:text-[35px] lg:text-[35px] text-[20px] font-sora text-white w-full '>We advocate for best practices and traceable results. We do this by our specialized and thorough procedures </p>
                <p className='2xl:text-[35px] lg:text-[35px] text-[20px] font-sora text-white w-full font-semibold'> <span className='text-primary-green font-semibold'>As builders, we transform business ideas into Establishments by means of trusted models and by providing hands-on technical skills.</span></p>
            </div>}
