    ...
    return (
        <div className="shadow-xl pt-0 font-sora w-[90vw] mx-auto -mt-20 " >
            <div className='grid grid-cols-4 w-full bg-black px-4 justify-items-center rounded-t-2xl'>
                <p className='my-4 text-primary-green font-semibold text-[16px]'>Project</p>
                <p className='my-4 text-primary-green font-semibold text-[16px]'>Description</p>
                <p className='my-4 text-primary-green font-semibold text-[16px]'>Status</p>
                <p className='my-4 text-primary-green font-semibold text-[16px]'>Location</p>
            </div>
